...
from users.views import LoginView, LogoutView, UserCreateView, UserUpdateView, generate_new_password, activate, \
...
urlpatterns = [
    ...
    path('register/verify_email/', TemplateView.as_view(template_name='users/verify.html'), name='verify'),
